...
func defaultIntentDefinitions() []IntentDefinition {
	return []IntentDefinition{
		...
		{ID: IntentCancel, Domain: DomainTask, ExactPhrases: []string{"取消", "取消任务", "停止", "停止任务", "停下", "停一下"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "cancel_task_or_operation"},
		...
		{ID: IntentQueuePause, Domain: DomainTask, ExactPhrases: []string{"暂停队列", "暂停任务队列", "停止排队任务"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "pause_queue"},
		{ID: IntentQueueResume, Domain: DomainTask, ExactPhrases: []string{"继续队列", "恢复队列", "继续任务队列"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "resume_queue"},
		{ID: IntentQueueClear, Domain: DomainTask, ExactPhrases: []string{"清空队列", "删除排队任务"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "request_clear_queue"},
		...
		{ID: IntentProjectSelect, Domain: DomainProject, ArgumentPrefixes: []string{"切换项目", "切到项目", "进入项目"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "select_project"},
		...
		{ID: IntentSessionSelect, Domain: DomainSession, ExactPhrases: []string{"会话列表", "列出会话", "选择会话"}, ArgumentPrefixes: []string{"切换会话", "切换到会话", "切到会话", "进入会话"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringDrain: true, AuditEvent: "select_session"},
		...
		{ID: IntentSessionRestore, Domain: DomainSession, ExactPhrases: []string{"已归档会话"}, ArgumentPrefixes: []string{"恢复会话", "找回会话"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringDrain: true, AuditEvent: "restore_session"},
		{ID: IntentSessionNew, Domain: DomainSession, ArgumentPrefixes: []string{"新建会话", "创建会话", "开一个新会话", "开个新会话"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringDrain: true, AuditEvent: "create_session"},
		{ID: IntentSessionRename, Domain: DomainSession, ArgumentPrefixes: []string{"重命名当前会话", "当前会话改名", "把当前会话改名"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringDrain: true, AuditEvent: "rename_session"},
		{ID: IntentSessionArchive, Domain: DomainSession, ExactPhrases: []string{"归档当前会话", "把当前会话归档", "归档这个会话"}, MutatesState: true, AllowDuringDrain: true, AuditEvent: "archive_session"},
		...
		{ID: IntentResponseVoice, Domain: DomainPreference, ExactPhrases: []string{"开启语音模式", "打开语音模式", "启用语音模式"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "set_response_voice"},
		{ID: IntentResponseAdaptive, Domain: DomainPreference, ExactPhrases: []string{"关闭语音模式", "退出语音模式", "自适应模式"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "set_response_adaptive"},
		{ID: IntentResponseReading, Domain: DomainPreference, ExactPhrases: []string{"开启阅读模式", "打开阅读模式", "阅读模式"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "set_response_reading"},
		{ID: IntentVisualStyle, Domain: DomainPreference, ExactPhrases: []string{"主题风格"}, ArgumentPrefixes: []string{"视觉风格", "卡片风格", "更换风格", "切换风格"}, AllowEmptyArgument: true, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "set_visual_style"},
		...
		{ID: IntentVoiceBriefing, Domain: DomainAutomation, ExactPhrases: []string{"语音简报", "播放简报", "工作简报", "发语音", "发个语音", "来段语音", "播报一下", "读给我听"}, AllowDuringTask: true, AllowDuringDrain: true, RequiresContextToken: true, AuditEvent: "send_voice_briefing"},
		{ID: IntentRemoteLock, Domain: DomainSecurity, ExactPhrases: []string{"远程锁定", "锁定 WeClaw", "锁定WeClaw", "锁定服务"}, MutatesState: true, AllowDuringTask: true, AllowDuringDrain: true, AuditEvent: "remote_lock"},
	}
}
