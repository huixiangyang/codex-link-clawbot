...
3. 按“Piper → MiMo”配置后发送“语音简报”或“发语音”，Piper 正常时必须先收到包含完整播报稿、当前项目和 `local` 提供商的阅读卡图片，再收到名为 `weclaw-briefing.mp3` 的微信文件；两者文字必须来自同一份播报稿，不得请求 MiMo，也不得追加单独状态卡。“发个语音”“来段语音”“播报一下”“读给我听”必须走同一音频控制链，不得进入 Codex。
